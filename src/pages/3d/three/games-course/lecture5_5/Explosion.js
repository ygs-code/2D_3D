// import { THREE.IcosahedronGeometry, THREE.TextureLoader, THREE.ShaderMaterial, THREE.Mesh, THREE.ShaderChunk } from '../../libs/three137/three.module.js';

import * as THREE from "three";
import { noise } from '@/pages/3d/utils/Noise.js';
import { Tween } from '@/pages/3d/utils/Toon3D.js';
...
`
  constructor(parent, obstacles) {
    ...
    this.uniforms = {
      ...
      u_tex: { value: new THREE.TextureLoader().load('/static/file/plane/explosion.png') }
    }
