...
import image from "@/assets/image/cat_400x400.jpg";
  ...
  const initTextures = (gl) => {
    ...
    $image.onload = function () {
      ...
      if (ratio === 1) {
        ...
        let y = 1 / ratio;
        verticesArr = [-1.0, -y, 0.0, 1.0, -y, 0.0, 1.0, y, 0.0, -1.0, y, 0.0];
      } else {
        shape = "verticalRectangle";
        let x = ratio;
        verticesArr = [-x, -1.0, 0.0, x, -1.0, 0.0, x, 1.0, 0.0, -x, 1.0, 0.0];
      }

      console.log(this.width);
      console.log(this.height);
      console.log("verticesArr=", verticesArr);
      console.log("verticesArr=", JSON.stringify(verticesArr));
      ...
      initVertexBuffers(gl, verticesArr);
      gl.uniform1f(u_Sampler, 0);
      draw(gl);
    };
  };
