...
window.onload = function () {
  ...
  if (!program) {
    ...
    function main() {
      ...
      // 将其绑定到ARRAY_BUFFER(将其视为ARRAY_BUFFER = colorBuffer)
      ...
      function drawScene() {
        ...
        target[0] = Math.sin(degToRad(targetAngleRadians)) * targetRadius;
        target[2] = Math.cos(degToRad(targetAngleRadians)) * targetRadius;
        ...
        // Clear the canvas AND the depth buffer. 清除画布和深度缓冲区。
...
//将被剔除。
        ...
        var type1 = gl.UNSIGNED_BYTE;  // the data is 8bit unsigned values
        var normalize1 = true;         // normalize the data (convert from 0-255 to 0-1)
      ...
      // 投影矩阵 角度   
        ...
        */
        ...
        //创建一个viewProjection矩阵。这两者都适用于透视
         //移动世界，使相机有效地成为原点
        /*
           视图矩阵 * 透视矩阵
